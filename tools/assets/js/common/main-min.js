BUI.use(["bui/menu", "bui/tab"], function (h, l) {
    ...
    var p = "dl-selected", c = "ks-hidden", y = "dl-last", x = "dl-hover", n = "nav-item", s = "dl-second-slib", f = "dl-tab-item", t = "dl-collapse", v = "dl-hide-current", u = "data-index", j = 145;
    ...
    function i(B, E, H, F, A) {
        var I = this, C = new h.SideMenu(H), D = new l.NavTab(E), J = $(H.render), z = J.next("." + s + "-con"), G = J.parents("." + f);
        if (z) {
            z.on("click", function () {
                G.toggleClass(t)
            });
    ...
    BUI.augment(w, {
        openPage: function (O) {
            var J = this, E = O.moduleId || J._getCurrentModuleId(), C = O.id, L = O.title || "\u65b0\u7684\u6807\u7b7e\u9875", B = O.href, N = O.isClose, D = O.closeable, A = O.reload, P = O.search;
            var G = J._getModule(E);
            if (G) {
                var H = G.tab, F = G.menu, z = F.getItem(C), K = H.getActivedItem(), M = K ? K.get("id") : null, I = J._getModuleIndex(E);
            ...
            module = new i(E, {render: A, height: a()}, {
                render: D,
                items: C.menu,
                height: a() - 5
            ...
            A.children().remove();
            $.each(B, function (D, E) {
                var F = E.id, C = ['<li class="dl-tab-item ks-hidden"><div class="dl-second-nav"><div class="dl-second-tree" id="J_', F, 'Tree"></div><div  style="display:none" class="', s, '-con" ><div class="', s, '"></div></div></div><div class="dl-inner-tab" id="J_', F, 'Tab"></div></li>'].join("");
                new $(C).appendTo(A)
            })
        }, _initDom: function () {
            var z = this;

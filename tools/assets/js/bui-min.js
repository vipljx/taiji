...
define("bui/util", function () {
    ...
    return e.ATTRS = {
        ...
        __createDom: function () {
            ...
            function u(t) {
                ...
                if (!n || n[0] != i[0]) e.set("curTrigger", i), e.fire("triggerchange", {
                    prevTrigger: n,
                    curTrigger: i
                });
    ...
    var t = e("bui/common"), n = e("bui/menu/menu"), r = t.Component, i = t.prefix + "menu-title", s = "menu-leaf", o = n.extend({
        initializer: function () {
            ...
            var n = this, r = e.items, s = [], o = {
                ...
                content: '<div class="' + i + '" style="display: none"><s></s><span class="' + i + '-text">' + e.text + "</span></div>"
            };
            return t.each(r, function (e) {
    ...
    var t = e("bui/common"), n = e("bui/menu"), r = t.Component, i = "tab-nav-list", s = "arrow-left", o = "arrow-right", u = "m_close", a = 150, f = r.View.extend({
        renderUI: function () {
